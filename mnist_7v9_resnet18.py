"""
ResNet-18 zur Unterscheidung der MNIST-Ziffern 7 und 9.
...
die Gewichte unter `mnist_7v9_resnet18.pth`.

Aufruf:
    .venv/bin/python mnist_7v9_resnet18.py
    .venv/bin/python mnist_7v9_resnet18.py --epochs 5 --batch-size 128
"""
...
DATA_DIR = HERE / "data"
WEIGHTS_PATH = HERE / "mnist_7v9_resnet18.pth"
